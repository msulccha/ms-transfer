package com.nttdata.mstransfer.service.impl;

import com.nttdata.mstransfer.entity.*;
import com.nttdata.mstransfer.repository.TransferRepository;
import com.nttdata.mstransfer.service.TransferService;
...
public class TransferServiceImpl implements TransferService {
    ...
    WebClient webClientCurrent = WebClient.create("http://localhost:9090/ms-current-account/currentAccount");

    WebClient webClientFixed = WebClient.create("http://localhost:9090/ms-fixed-term/fixedTerm");

    WebClient webClientSaving = WebClient.create("http://localhost:9090/ms-saving-account/savingAccount");
